...
CREATE TABLE usuario_permissao (
	...
	CONSTRAINT usuario_permissao_fk_usuario FOREIGN KEY (usuario_id) REFERENCES usuario(id),
  CONSTRAINT usuario_permissao_fk_permissao FOREIGN KEY (permissao_id) REFERENCES permissao(id)
);
